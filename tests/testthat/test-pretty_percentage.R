...
test_that("pretty_percentage is correctly dealing with numeric vector inputs", {
  num_vector <- c(100, 10, 45, 1000, 45, 201, 34, 16)
  denom_vector <- c(232, 100, 398, 2332, 20321, 10, 100, 48)
  results_vector <- c("43.1% (100/232)",   "10.0% (10/100)", "11.3% (45/398)", "42.9% (1000/2332)", "0.2% (45/20321)", "2010.0% (201/10)", "34.0% (34/100)", "33.3% (16/48)")
